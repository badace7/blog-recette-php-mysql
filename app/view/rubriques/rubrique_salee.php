                ...
                foreach ($recettes as $recette) {
                    ...
                    <div class="rubrique-item">
                        <div class="rubrique-img">
                            ...
                            if($role == 'ROLE_ADMIN') { echo'<span class="icon-close"><a style="text-decoration: none;" href="index.php?action=delete&id='.$recette->getId_recette().'&type=rubrique_salee"><i class="fas fa-times"></i></a></span>'; }  
